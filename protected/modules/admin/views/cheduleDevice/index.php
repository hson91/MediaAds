...
$this->widget('zii.widgets.grid.CGridView', array(
    ...
    'columns'=>array(
        ...
        array(
            'name'=>'scheduleID','type'=>'raw',
            'htmlOptions'=>array('class'=>'ct','style'=>'width:100px'),
        ),
        array(
            'name'=>'timeStart',
            'filter'=>false,
            'value'=>'date("d-m-Y H:i:s",$data->timeStart)',
            'type'=>'raw',
        ...
        array(
            'name'=>'timeEnd',
            'filter'=>false,
            'value'=>'date("d-m-Y H:i:s",$data->timeEnd)',
            'type'=>'raw',
            'htmlOptions'=>array('class'=>'ct'),
        ),array(
            'name'=>'flagExpire','type'=>'raw',
            // 'filter'=>Yii::app()->params["flag_expire"],
            // 'value'=>'Yii::app()->params["flag_expire"][$data->flagExpire]',
            'htmlOptions'=>array('class'=>'ct','style'=>'width:100px'),
        ),
        array(
            'name'=>'flagDelete','type'=>'raw',
            // 'filter'=>Yii::app()->params["flag_delete"],
            // 'value'=>'Yii::app()->params["flag_delete"][$data->flagDelete]',
            'htmlOptions'=>array('class'=>'ct','style'=>'width:100px'),
        ),
        array(
